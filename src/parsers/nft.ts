...
import { SOL, unknownProtonTransaction } from "../types/parser";
...
function returnCompressedNftEventArray(value: CompressedNftEvent[] | CompressedNftEvent | null): CompressedNftEvent[] {
    ...
    for (let i = 0; i < nftEvent.length; i++) {
        ...
        if (!address) {
            actions.push({
                ...
                amount: 1,
                from: "",
                sent: nftEventAction.assetId ?? "Unknown Asset",
                to: nftEventAction.newLeafOwner ?? "Unknown Owner",
            });
            ...
            actions.push({
                ...
                amount: 1,
                from: "",
                received: nftEventAction.assetId ?? "Unknown Asset",
